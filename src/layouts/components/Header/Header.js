                ...
                <div className={cx('action')}>
                    {currentUser ? (
                        ...
                        <>
                            ...
                            <Button className={cx('custom-btn')} primary to="/" href="/">
                                Log in
                            </Button>
                        </>
                    )}

                    <PopperMenu items={currentUser ? MENU_FULL_OPTIONS : MENU_ITEMS} onChange={handleMenuChange}>
                        {currentUser ? (
                            <Image
